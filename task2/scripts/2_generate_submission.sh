...
if [[ $PIPELINE_VERSION != "main_build" ]]; then
  VERSION_FILE="output/datasets/match_modality/VERSION"
...
echo "> evalai challenge 1111 phase 2277 submit --file submission.zip --large --private"
echo ""
echo "Or this command to create a public one:"
echo "> evalai challenge 1111 phase 2277 submit --file submission.zip --large --public"
echo ""
echo "Good luck!"
